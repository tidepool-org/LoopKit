...
COLOR_PALETTE_DERIVED="${DIRECTORY}/DerivedColorPalette.xcassets"
COLOR_PALETTE_BASE="${DIRECTORY}/DerivedColorPaletteBase.xcassets"
COLOR_PALETTE_OVERRIDE="${DIRECTORY}/DerivedColorPaletteOverride.xcassets"

info "Removing derived color palette for ${DIRECTORY}..."
...
if [ -e "${COLOR_PALETTE_OVERRIDE}" ]; then
  info "Copying color palette override to the derived color palette..."
