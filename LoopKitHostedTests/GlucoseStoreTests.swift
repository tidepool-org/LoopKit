...
class GlucoseStoreTests: PersistenceControllerTestCase, GlucoseStoreDelegate {
    ...
    private let sample2 = NewGlucoseSample(date: Date(timeIntervalSinceNow: -.minutes(2)),
                                           ...
                                           condition: nil,
                                           trend: .flat,
                                           trendRate: HKQuantity(unit: .milligramsPerDeciliterPerMinute, doubleValue: 0.0),
                                           isDisplayOnly: false,
                                           wasUserEntered: true,
    ...
    private let sample3 = NewGlucoseSample(date: Date(timeIntervalSinceNow: -.minutes(4)),
                                           ...
                                           condition: .aboveRange(threshold: HKQuantity(unit: .millimolesPerLiter, doubleValue: 7.0)),
                                           trend: .upUpUp,
                                           trendRate: HKQuantity(unit: .millimolesPerLiterPerMinute, doubleValue: 0.2),
                                           isDisplayOnly: false,
                                           wasUserEntered: false,
