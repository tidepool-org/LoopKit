...
public struct CorrectionRangeInformationView: View {
    ...
    private var text: some View {
        VStack(alignment: .leading, spacing: 25) {
            ...
            .bold()
            Text(LocalizedString("For this range, choose the specific glucose value (or range of values) that you want \(appName) to aim for in adjusting your basal insulin.", comment: "Information about correction range"))
