...
public protocol CGMManagerProvider: AnyObject {
    ...
    /// This descriptor list of available CGM managers.
...
public protocol PumpManagerProvider: AnyObject {
    ...
    /// This descriptor list of available pump managers.
...
public protocol ServiceProvider: AnyObject {
    ...
    /// This descriptor list of available services.
...
public protocol OnboardingDelegate: AnyObject {
    ...
    ///
    /// - Parameters:
    ///     - notifying: The source of the notification.
...
public protocol OnboardingUI: Onboarding {
    ...
    func onboardingViewController(preferredGlucoseUnit: HKUnit,
                                  ...
                                  colorPalette: LoopUIColorPalette) -> (UIViewController & OnboardingNotifying & CGMManagerCreateNotifying & CGMManagerOnboardNotifying & PumpManagerCreateNotifying & PumpManagerOnboardNotifying & ServiceCreateNotifying & ServiceOnboardNotifying & CompletionNotifying)
}
